              ...
              <div className="bg-card border border-card-border rounded-xl p-6">
                ...
                <div className="grid grid-cols-3 gap-3 mb-5">
                  {[
                    ...
                    <label
                      key={value}
                      className={`flex flex-col items-center gap-2 p-3 border rounded-xl cursor-pointer transition-colors ${paymentMethod === value ? "border-primary bg-primary/5" : "border-border hover:border-primary/40"}`}
                    >
                      <input
                        type="radio"
                ...
                {paymentMethod === "card" && (
                  <div className="space-y-4 border-t border-border pt-5">
                    <div className="bg-gradient-to-br from-primary to-secondary text-white p-5 rounded-xl relative overflow-hidden">
                      ...
                      <p className="text-xs opacity-70 mb-3 uppercase tracking-widest">
                        Payment Card
                      </p>
                      ...
                      <div className="flex justify-between">
                        <div>
                          ...
                          <p className="text-sm font-medium">
                            {watch("cardName") || "YOUR NAME"}
                          </p>
                        </div>
                        <div className="text-right">
                          <p className="text-xs opacity-70">Expires</p>
                          <p className="text-sm font-medium">
                            {watch("cardExpiry") || "MM/YY"}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="border-t border-border pt-5">
                    <div className="flex items-start gap-3 bg-muted rounded-lg p-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Pay with cash when your order is delivered. Our delivery
                        person will collect the payment.
                      </p>
                    </div>
                  </div>
                )}
